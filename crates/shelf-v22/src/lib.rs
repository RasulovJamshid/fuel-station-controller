//! SHELF V2.2 wire codec, including captured liquid-fuel dispenser replies.
//!
...
/// SHELF volume fields use hundredths of the product unit (litres or m³).
pub const VOLUME_STEPS_PER_UNIT: f64 = 100.0;
