...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::wetstock_preview,
            commands::wetstock_reconcile,
            commands::list_reconciliations,
            commands::admin_list_scheduled_prices,
            commands::admin_schedule_price,
            commands::admin_cancel_scheduled_price,
